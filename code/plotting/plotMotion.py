...
for sub in ['sub-12']:
    ...
    outFolder = f'/media/sebastian/Data/EVENTRELATED_PILOT/rawData/Nifti/derivativesTestTest/{sub}/ses-001'
    ...
    for run in runs:
        ...
        if 'ses-002' in run:
            ses = 'ses-002'
        outFolder = f'/media/sebastian/Data/EVENTRELATED_PILOT/rawData/Nifti/derivativesTestTest/{sub}/{ses}/func'
        ...
        FDs.to_csv(f'{root}/derivativesTestTest/{sub}/{ses}/func/motionParameters/{base}_FDs.csv', index=False)
